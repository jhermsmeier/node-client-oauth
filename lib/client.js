...
var OAuthClient = (function() {
  ...
  /*
   * Constructs a new OAuthClient from
   * given options.
   * 
   * @api public
  ...
  /*
   * Generates a nonce to be
   * used in a OAuth request.
   * 
   * @api public
   * @return {String} nonce
   */
  ...
  $.getRequestToken = function( params, callback ) {
    this.getToken( this.options.tokenUrl, params, callback );
  };
  
  $.getAccessToken = function( params, callback ) {
    this.getToken( this.options.accessUrl, params, callback );
  };
  
  $.getToken = function( resource, params, callback ) {
  ...
  $.request = function( method, resource, params, callback ) {
    ...
    resource = this.options.baseUrl + resource;
